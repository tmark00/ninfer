...
public:
    ...
    // Tokens of reusable prefix a retained lane holds; zero for a lane with nothing retained.
    [[nodiscard]] std::uint32_t retained_prefix_tokens(std::uint32_t lane) const noexcept;
